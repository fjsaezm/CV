...
\begin{tabular}{p{3cm}|p{11cm}}
  \textsc{Bacherlor's}               & \textsc{Representation learning using contrastive learning in images}                                                                                                                                                                                                           \\
  \textsc{thesis} & \footnotesize Reviewed the state-of-art frameworks that use contrastive learning to learn good representations for downstream tasks. Also reviewed mutual information lower bounds for machine learning. \url{https://github.com/fjsaezm/Mutual-Information-in-Unsupervised-Machine-Learning}.                                                              \\
...
Representation Learning, Variational Inference, Contrastive Learning, Statistics, Open Source, Unsupervised Learning, Deep Learning
